...
#ifndef AGGX_CONV_ADAPTOR_VCGEN_INCLUDED
#define AGGX_CONV_ADAPTOR_VCGEN_INCLUDED
...
namespace aggx
{
	...
	{
		void remove_all() {}
		void add_vertex(real, real, unsigned) {}
		void prepare_src() {}
	...
	public:
		explicit conv_adaptor_vcgen(VertexSource& source, typename Generator::vertex_storage &vs,
				typename Generator::coord_storage &cs)
			: m_source(&source), m_generator(vs, cs), m_status(initial)
		{	}
