...
#ifndef AGGX_STROKE_MATH_INCLUDED
#define AGGX_STROKE_MATH_INCLUDED
...
namespace aggx
{
		...
		real dx2, real dy2) const
	{
		...
		da = acos(m_width_abs / (m_width_abs + 0.125f / m_approx_scale)) * 2;
		...
		real len) const
	{
		...
		{
			real da = acos(m_width_abs / (m_width_abs + 0.125f / m_approx_scale)) * 2;
			real a1;
			int i;
			int n = int(pi / da);
