...
#ifndef AGGX_CONV_STROKE_INCLUDED
#define AGGX_CONV_STROKE_INCLUDED

#include "basics.h"
#include "aggx_vcgen_stroke.h"
#include "aggx_conv_adaptor_vcgen.h"
...
namespace aggx
{
	...
	struct conv_stroke : public conv_adaptor_vcgen<VertexSource, vcgen_stroke, Markers>
	{
		...
		conv_stroke(VertexSource& vs, vcgen_stroke::vertex_storage &vstorage, vcgen_stroke::coord_storage &cs)
			: conv_adaptor_vcgen<VertexSource, vcgen_stroke, Markers>(vs, vstorage, cs)
		{
		}
