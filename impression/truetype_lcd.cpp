...
static char pangram[] = "I...A Quick Brown Fox Jumps Over The Lazy Dog...I";
...
{
	typedef agg2::pixmap<blender_rgb<agg::rgba8, agg::order_rgb>, agg::rendering_buffer> pixfmt;
...
public:
    ...
    double draw_text(Rasterizer& ras, Scanline& sl, 
                     RenSolid& ren_solid, 
                     const char* font, bool italic, const char* text, 
                     ...
                     unsigned subpixel_scale)
    {
        ...
        m_feng.scale_x(scale_x * subpixel_scale);
        m_feng.italic(italic);
        m_feng.hinting(m_hinting.status());
        if(m_feng.create_font(font, agg::glyph_ren_outline))
        {
            const char* p = text;
			...
			agg2::render_scanlines_aa_solid(ras, sl, ren_solid, color);
        }
    ...
    virtual void on_draw()
    {
        ...
        renderer.clear(agg::rgba8(255, 255, 255));

        //if(m_invert.status())
        //{
        //    renderer.copy_bar(0, 120, pf.width(), pf.height(), agg::rgba8(0, 0, 0));
        //}


        agg2::scanline_u8 sl;
        aggx::rasterizer_scanline_aa<agg::rasterizer_sl_clip_int> ras;
		...
		agg2::renderer_base<agg::pixfmt_rgb24_lcd> renderer_lcd(pf_lcd);
        ...
        const char* typeface = "Calibri";

        switch(m_typeface.cur_item())
        {
        case 1: typeface = "Tahoma";  break;
        case 2: typeface = "Verdana"; break;
        case 3: typeface = "Times New Roman"; break;
        case 4: typeface = "Georgia"; break;
        }
        ...
        {
            y  = draw_text(ras, sl, renderer, typeface, false, text1, 10, y, k*12, 1); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, renderer, typeface, true,  text2, 10, y, k*12, 1); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, renderer, typeface, false, text3, 10, y, k*12, 1); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, renderer, typeface, true,  text4, 10, y, k*12, 1); 
            y -= 7 + k*12;
        }
        else
        {
            y  = draw_text(ras, sl, renderer_lcd, typeface, false, text1, 10, y, k*12, 3); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, renderer_lcd, typeface, true,  text2, 10, y, k*12, 3); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, renderer_lcd, typeface, false, text3, 10, y, k*12, 3); 
            y -= 7 + k*12;
            y  = draw_text(ras, sl, renderer_lcd, typeface, true,  text4, 10, y, k*12, 3); 
            y -= 7 + k*12;
        }
        ...
        //    for(int i = 0; i < 30; ++i)
        //    {
        //        draw_text(ras, sl, renderer, typeface, false, pangram, 10+i/10., y, k*11, 1);  y -= k*11;
        //    }
        //}
        //else
        //{
        //    for(int i = 0; i < 30; ++i)
        //    {
        //        draw_text(ras, sl, renderer_lcd, typeface, false, pangram, 10+i/10., y, k*11, 3);  y -= k*11;
        //    }
        //}
        ...
        //if(m_grayscale.status())
        //{
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*10, 1); y -= 3+k*10;
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*11, 1); y -= 3+k*11;
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*12, 1); y -= 3+k*12;
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*13, 1); y -= 3+k*13;
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*14, 1); y -= 3+k*14;
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*15, 1); y -= 3+k*15;
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*16, 1); y -= 3+k*16;
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*17, 1); y -= 3+k*17;
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*18, 1); y -= 3+k*18;
        //    draw_text(ras, sl, renderer, typeface, true, pangram, 10, y, k*19, 1); y -= 3+k*19;
        //}
        //else
        //{
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*10, 3); y -= 3+k*10;
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*11, 3); y -= 3+k*11;
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*12, 3); y -= 3+k*12;
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*13, 3); y -= 3+k*13;
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*14, 3); y -= 3+k*14;
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*15, 3); y -= 3+k*15;
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*16, 3); y -= 3+k*16;
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*17, 3); y -= 3+k*17;
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*18, 3); y -= 3+k*18;
        //    draw_text(ras, sl, renderer_lcd, typeface, true, pangram, 10, y, k*19, 3); y -= 3+k*19;
        //}
...
//        pf.apply_gamma_inv(m_gamma_lut);
        ...
        agg::render_ctrl(ras, sl, renderer, m_typeface);
        agg::render_ctrl(ras, sl, renderer, m_height);
        agg::render_ctrl(ras, sl, renderer, m_faux_italic);
        agg::render_ctrl(ras, sl, renderer, m_faux_weight);
        agg::render_ctrl(ras, sl, renderer, m_interval);
        agg::render_ctrl(ras, sl, renderer, m_width);
        agg::render_ctrl(ras, sl, renderer, m_gamma);
        agg::render_ctrl(ras, sl, renderer, m_primary);
        agg::render_ctrl(ras, sl, renderer, m_hinting);
        agg::render_ctrl(ras, sl, renderer, m_kerning);
        agg::render_ctrl(ras, sl, renderer, m_invert);
        agg::render_ctrl(ras, sl, renderer, m_grayscale);
