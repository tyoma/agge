...
namespace
{
	...
	private:
		...
		agge::queue<rendition_pack> _unsorted;
      hybrid_event _unsorted_ready;
      agge::queue<rendition_pack> _sorted;
      hybrid_event _sorted_ready;
      agge::queue<rasterizer_type *> _free;
...
#pragma pack(1)
	...
	async<RasterizerT>::async(count_t n)
		: _renderer(2), _sorter_thread(&sorter_proc, this), _renderer_thread(&rendition_proc, this)
	{
		while (n--)
		{
